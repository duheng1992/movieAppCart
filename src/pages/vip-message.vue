    ...
    <div class="vippage-container">      
        <div class="user-detail">        
            ...
            <div class="user-detail__message">
                <p class="user-detail__message__name">昵称：<span>duheng</span></p>
            
			     <p class="user-detail__message__phone">地址：<span>https://github.com/duheng1992</span></p>
            </div>
        ...
        <div class="operate">
            ...
            <transition name="slide">
                 <v-touch tag="div" v-on:swipeleft="hideSilde" class="other-set" v-show="isShow">                    
                        ...
                        <ul>
                            <li class="iconfont icon-set">我的资料</li>
                            <li class="iconfont icon-set">订单查询</li>
                            <li class="iconfont icon-set">系统设置</li>
                            <li class="iconfont icon-set">退出    </li>
                        </ul>
                 </v-touch>           
            </transition>
            <!-- 一层掩模 -->
